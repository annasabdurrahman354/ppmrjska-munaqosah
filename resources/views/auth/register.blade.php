                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-medium text-sm mb-2" for="name">
                                    {{ __('global.user_name') }}
                                </label>
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-medium text-sm mb-2" for="password">
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-medium text-sm mb-2" for="password_confirmation">
                            ...
                            <div class="text-center mt-4">
                                @if(Route::has('login'))
                                Sudah punya akun?
                                    <a href="{{ route('login') }}" class="underline text-md text-blueGray-100 hover:text-gray-400">
                                        {{ __('global.login') }}
                                    </a>
                                @endif
                            </div>
