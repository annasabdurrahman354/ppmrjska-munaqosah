    ...
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @if(file_exists(app_path('Http/Livewire/Admin/ExcelExport.php')))
                <livewire:admin.excel-export model="Kelurahan" format="csv" />
                <livewire:admin.excel-export model="Kelurahan" format="xlsx" />
                <livewire:admin.excel-export model="Kelurahan" format="pdf" />
            @endif
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('kelurahan_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.kelurahans.show', $kelurahan) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('kelurahan_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.kelurahans.edit', $kelurahan) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('kelurahan_delete')
