    ...
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @if(file_exists(app_path('Http/Livewire/Admin/ExcelExport.php')))
                <livewire:admin.excel-export model="Kabupaten" format="csv" />
                <livewire:admin.excel-export model="Kabupaten" format="xlsx" />
                <livewire:admin.excel-export model="Kabupaten" format="pdf" />
            @endif
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('kabupaten_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.kabupatens.show', $kabupaten) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('kabupaten_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.kabupatens.edit', $kabupaten) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('kabupaten_delete')
